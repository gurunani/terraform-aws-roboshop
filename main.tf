...
# # Listener Rule to route traffic to var.component
...
#   vpc_security_group_ids = [local.var.sg_id]
...
# # Provision var.component instance
# resource "terraform_data" "main" {
#   triggers_replace = [
#     aws_instance.var.main.id
#   ]
...
#   triggers_replace = [
#     aws_ami_from_instance.ma in.id
#   ]
...
#   depends_on = [terraform_data.var.component_delete]
# }
...
#   depends_on = [aws_launch_template.var.component]
# }
...
#   cooldown               = 120
#   autoscaling_group_name = aws_autoscaling_group.var.component.name
# }

# # Auto Scaling Policy - Scale Down
# resource "aws_autoscaling_policy" "var.component_scale_down" {
...
# resource "aws_cloudwatch_metric_alarm" "var.component_cpu_high" {
...
#   dimensions = {
#     AutoScalingGroupName = aws_autoscaling_group.var.component.name
#   }

#   alarm_actions = [aws_autoscaling_policy.var.component_scale_up.arn]
# }

# # CloudWatch Alarm - Low CPU
# resource "aws_cloudwatch_metric_alarm" "var.component_cpu_low" {
...
#   alarm_actions = [aws_autoscaling_policy.var.component_scale_down.arn]
# }
resource "aws_lb_target_group" "main" {
  name     = "${var.project}-${var.environment}-${var.component}"
  port     = local.tg_port
